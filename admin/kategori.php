...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <h2>E-ELECTRICAL</h2>
            <button type="button" onclick="location.href='tambahkategori.php'"><i class="glyphicon glyphicon-plus"></i></button>
            <center>
            <table border="2">
               ...
               while($row = $result->fetch()){ 
                ?>
                        ...
                        <tr>
                            ...
                            <td p align="center" bgcolor="#FFFFFF"><?php echo $row['kategori']; ?></td>
                            <td><center><a href="editkategori.php?kod=<?php echo $row['id_kategori'];?>" title="Edit">
                            <i class="glyphicon glyphicon-pencil"></i></a>
                                 <a href="deletekategori.php?kod=<?php echo $row['id_kategori'];?>">
